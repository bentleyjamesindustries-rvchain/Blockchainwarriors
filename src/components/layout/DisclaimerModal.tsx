    ...
    <Dialog open={open}>
      <DialogContent className="max-w-md" hideClose>
        <DialogHeader>
          ...
          <DialogDescription>
            Blockchain Warriors is for education and simulation only. It does not place live orders and is not
        ...
        <Button className="mt-2 w-full" onClick={accept}>
          I understand — paper only
        </Button>
      </DialogContent>
    </Dialog>
  );
